...
public class LaporanBeliAdapter extends BaseAdapter {
    Context context;
    ArrayList<String[]> laporan_list;
    LayoutInflater inflter;

    public LaporanBeliAdapter(Context applicationContext, ArrayList<String[]> ls){
    ...
    public View getView(int i, View view, ViewGroup parent) {
        if(!laporan_list.isEmpty()){
            ...
            txt_desc2.setText("Supplier : "+laporan_list.get(i)[4]);
