...
import sicill.utsmobile.Adapter.LaporanJualAdapter;
...
public class LaporanPenjualan extends AppCompatActivity {
    ...
    private void get_data(String tgl1, String tgl2){
        ...
        while (c.moveToNext()){
            ...
            ret[2] = c.getString(c.getColumnIndex("CUSTOMER"));
            ret[3] = c.getString(c.getColumnIndex("TOTAL"));
            dataLaporan.add(ret);
